...
public class ExtractNeighbours extends VCFFunction {
  ...
  public Description getDesc() {
    return new Description("Scans the whole VCF file, for each successive variants V1 and V2")
        ...
        .addLine("chr V1_pos V2_pos is printed if, at least one alternate allele of V1_pos and V2_pos is a SNP, and if one sample has a variant of both side (not necessarily the SNP one).");
  }
